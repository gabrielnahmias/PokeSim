/**!
 * A Pokémon simulator with authentic visualizations and more.
 * 
 * @author Gabriel Nahmias (gabriel@terrasoftlabs.com/gnahmias@memphis.edu)
 * @version 1.0
 * @using doxygen (code documentation generator),
 *        jacobe (beautifier) 
 */
// Standard
import java.io.*;
...
public class PokemonSimulator
{
     ...
     * Constructor
     */
    public PokemonSimulator(int id)
    {
        // Initialise ID instance variable with a bit of logic
        // to only apply the given ID if it is greater than 0.
        if (id > 0) {
            this.id = id;
        } else {
            this.id = 1;
    ...
    // Constants
    public static final int INT_NL_COUNT = 20;      // Number of newlines to print (used in method) for easy adjustment.
    public static final String NAME = "PokéSim";
    
    // Instance variables (some may be fixed)
    public int id;                                  // This instance's given ID (any integer). 
    public static int x = 0,
                      y = 0;
    public static int enemyHealth = 100,
                      pikachuHealth = 100;
    public static boolean game = true;
    public static String eh1 = "*", eh2 = "*",
                         eh3 = "*", eh4 = "*",
                         eh5 = "*", eh6 = "*",
                         eh7 = "*", eh8 = "*",
                         ph1 = "*", ph2 = "*",
    ...
    public static void main(String[] args) {
        ...
        while (game==true)
        {
            // THIS DOES NOT WORK BUT WHY??? If only you could
            // turn Java source code into executables... why?!?!
            // Answer me that, teach! WHYYYYY???
            /*
            try {
    ...
    public static void pokemonBattle(int pokemonNumber)
    {
        ...
        // Rattata: normal-type Pokémon
        if (pokemonNumber==7)
            wildPokemonName = "Rattata"; // Bananas easy.
        // Rattata: grass-type
        if (pokemonNumber==8)
            wildPokemonName = "Weedle"; // If you go through Kakuna, this one is worth a Butterfly.
        // Rattata: fighting-type
        if (pokemonNumber==9)
            wildPokemonName = "Mankey"; // Fierce little beasty.
        
        // The "texture" for the landscape.
